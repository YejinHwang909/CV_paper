...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        # self.conv1과 self.downsample 레이어들은 stride가 1이 아닐때 다운샘플한다.
...
class ResNet(nn.Module):
    def __init__(
        ...
        # 각 residual branch의 마지막 BN은 Zero-initialize 해준다.
        # 이는 각 residual branch가 0에서 시작하고 identity처럼 행동하게 만든다.
